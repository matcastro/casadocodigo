			...
			<div id="header-content">
				<nav id="main-nav" >
					...
					<security:authorize access="hasRole('ROLE_ADMIN')">
						...
						<li><a href="${s:mvcUrl('PSC#getPedidos').build() }" rel="nofollow"><fmt:message key="menu.lista_pedidos"/></a></li>
						<li><a href="${s:mvcUrl('UC#lista').build() }" rel="nofollow"><fmt:message key="menu.lista_usuarios"/></a><li>
